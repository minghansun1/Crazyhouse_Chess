...
// A representation of a rook in crazyhouse. This class will implement the rook's movement,
// capturing, and placing. Extends the GamePiece Class
public class Rook extends GamePiece {
    private String IMG_File;
    public Rook(int r, int c, boolean color, boolean p, int pN) {
        super(r, c, color, p, pN);
        if (color) {
            IMG_File = "files/Chess_rlt60.png";
        } else {
            IMG_File = "files/Chess_rdt60.png";
        }
    }
    @Override
